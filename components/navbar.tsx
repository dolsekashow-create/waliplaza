      ...
      <div className="mx-auto flex h-20 max-w-6xl items-center justify-between gap-3 px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden items-center gap-2 rounded-full bg-gradient-brand px-5 py-2.5 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90 sm:flex"
          >
