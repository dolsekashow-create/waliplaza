  ...
  return (
    <html lang="ar" dir="rtl" className={`${cairo.variable} bg-background`}>
      <body className="antialiased font-sans">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:top-3 focus:right-3 focus:z-[80] focus:rounded-full focus:bg-card focus:px-4 focus:py-2 focus:text-sm focus:font-bold focus:shadow-lg"
        >
          تخطي إلى المحتوى
        </a>
        <SelectionProvider>
