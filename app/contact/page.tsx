...
import { PHONES, WHATSAPP_DISPLAY, WHATSAPP_URL, MAP_URL, whatsappLink } from '@/lib/site'
        ...
        >
          <span className="flex items-center gap-3">
            ...
            <span className="text-start">
              <span className="block text-lg font-extrabold">موقع المعرض</span>
              <span className="block text-sm text-muted-foreground">
                افتح الموقع على خرائط جوجل للوصول إلينا
              </span>
            </span>
          </span>
